            ...
            <div class="col-sm-12 pt-3 ">
                <div class="card-block  ">
                    ...
                    <ul>
                        ...
                        <li>Wiping down all mirrors and glass surfaces/furniture</li>
                        <li>Vacuuming/Cleaning floors</li>
                        <li>Taking out garbage</li>
                    </ul>
                    <strong>Bedrooms &amp; Common Areas</strong><br>
                    <ul>
                        <li>General dusting of all surfaces</li>
                        <li>Wiping down mirrors and glass surfaces/furniture</li>
                        <li>Vacuuming / Cleaning floors</li>
                        <li>Taking out garbage</li>
                    </ul>
                    ...
                    <ul>
                        <li>General dusting of all surfaces</li>
                        <li>Washing dishes / loading dishwasher</li>
                        <li>Cleaning exterior surfaces (stove, cabinets, fridge)</li>
                        <li>Vacuuming / Cleaning floors</li>
                        <li>Taking out garbage</li>
                    </ul>
