            ...
            <div class="container list-group-item" style="border: 0 !important;">
                <div class="">
                    <div class="pt-5 pb-4" style=" ">
                        ...
                        <h1 style="color: #666 !important;text-shadow: #e0e0e0 1px 1px 0;font-size: 1.75rem;font-we4ight: bold" class="display-4 text-normal banner-text">The easiest way to book a home cleaning
                            expert</h1>
                        <h1 style="font-weight:bold;color: #666 !important;text-shadow: #e0e0e0 1px 1px 0;font-size: 1rem;font-wei4ght: bold;padding-top:1rem;" class="display-4 text-normal banner-text">Re-launch
                            Special</h1>
                        ...
                        <h1 class="display-4 banner-text text-normal" style="color: #666 !important;font-size: 2rem;font-weight: bold">25% Off All Services!</h1>
                    ...
                    <!--h1 style="color: #666 !important;text-shadow: #dadada 1px 1px 0;font-size: 1rem;font-wei4ght: bold" class="display-4 text-normal banner-text"><br>Contact Canbii Cleaners<br>info@canbii.com </h1-->
                </div>
            </div>
        </div>
                ...
                <div class="row my-4">
                    <div class="col-lg-12">
                        ...
                        <div class="alert alert-danger" role="alert">
                            <strong>[COVID-19 Update] Cleaning Supplies No Longer Included</strong><br>To avoid cross-contamination from home to home; we ask that you supply the vacuum cleaner and mop.
                            If you don't have supplies, we can bring them for an additional charge of $15.
                        </div>
            ...
            <div class="row my-4">
                <div class="col-lg-3">
                    <div class="   list-group-item">
                        <div class="card card-body bg-white">
                            ...
                            <h5 class="card-title text-primary"> CHOOSE YOUR TIME
                            </h5>
                ...
                <div class="col-lg-3 pa-3 ">
                    <div class="   list-group-item">
                        <div class="card card-body bg-white">
                            ...
                            <h5 class="card-title text-primary"> PAY SECURELY ONLINE
                            </h5>
                ...
                <div class="col-lg-3 pa-3 ">
                    <div class="   list-group-item">
                        <div class="card card-body bg-white">
                            ...
                            <h5 class="card-title text-primary"> SIT BACK & RELAX
                            </h5>
                ...
                <div class="col-lg-3 pa-3  ">
                    <div class=" list-group-item">
                        <div class="card card-body bg-white">
                            <h3 class="mb-3 text-center"><i class="fa fa-leaf mr-1 " style="color:  #d7d7d7;"></i></h3>
                            <h5 class="card-title text-primary"> THE CANBII PROMISE
                            </h5>
                ...
                <div class="col-lg-8 ">
                    <div class="list-group-item">
                        <div class="">
                            ...
                            <br>
                            <p>The following list outlines common tasks our cleaners perform for a basic cleaning. If you'd like us to use your own products, please add a note to your appointment with
                            ...
                            <p> We pay special attention to detail on every project to ensure the complete satisfaction of each client. ​Our goal is to make sure that we leave your home with sparkling kitchen,
        ...
        <div class="row">
            <div class="col-md-12">
                <label class=" d-block text-center py-2 mt-4">
                    Canbii &copy; 2013 - 2020 / <a HREF="<?= webroot("help");?>" class="text-muted">About / <a HREF="<?= webroot("help");?>" class="text-muted">Terms</a>
                </label>
            </div>
        </div>
    </div>
