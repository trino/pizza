...
<div class="list-group-item container-fluid shadow bg-danger">
   ...
   box-shadow: none;" aria-haspopup="true" aria-expanded="false" class="btn bg-transparent togglemenu"
    ...
    <ul class="dropdown-menu dropdown-menu-left" ID="dropdown-menu">
                    <SPAN class="loggedin profiletype profiletype1">
                        ...
                        <LI><A CLASS="dropdown-item" HREF="<?= webroot("map", true); ?>"><i
                                        class="fa fa-question-circle icon-width"></i> Map</A></LI>
                    </SPAN>
        <SPAN class="loggedin">
                        <li id="profileinfo">
            ...
            @if($routename != "help")
                <li class="profiletype_not profiletype_not2"><A CLASS="dropdown-item" HREF="javascript:orders();"><i
                                class="fa fa-clock icon-width"></i> Past Orders</A></li>
            @endif
                    </SPAN>

        <SPAN class="loggedout">
                    <LI><A CLASS="dropdown-item" HREF="javascript:showlogin('login');"><i
                                    class="fa fa-user icon-width"></i> Log In</A></LI>
                </SPAN>

        @if($routename == "help")
            <LI><A CLASS="dropdown-item" HREF="<?= webroot("", true); ?>"><i
                            class="fa fa fa-shopping-cart icon-width"></i> Menu</A></LI>
        @else
            <LI><A CLASS="dropdown-item" HREF="<?= webroot("help", true); ?>"><i
                            class="fa fa-question-circle icon-width"></i> About Us</A></LI>
        @endif

        <LI><A CLASS="dropdown-item" HREF="https://hammerpizza.ca/blog/pizza-giveaway/"><i
                        class="fa fa-star icon-width"></i> Weekly Giveaway</A></LI>


        <LI class="loggedin"><A CLASS="dropdown-item" href="javascript:handlelogin('logout');"><i
    ...
    <a style="color: white; text-decoration: none;font-weight: bold" HREF="<?= webroot("index"); ?>"
       class="white text-center" href="/"><?= strtoupper(sitename); ?></a>
