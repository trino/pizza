...
@if(!$justright)
    <DIV CLASS="py-3 px-3">
            <ul class="nav nav-tabs mb-1" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active bold" href="#profile" role="tab" data-toggle="tab" id="logintab" onclick="skiploadingscreen = false; ajaxerror();">Login</a>
                </li>
                <A class="nav-link">
                    &nbsp;or&nbsp;
                </A>
                <li class="nav-item">
                    <a class="nav-link bold" href="#buzz" role="tab" data-toggle="tab" id="signuptab" onclick="skiploadingscreen = true; ajaxerror();">Signup</a>
                </li>
            </ul>
        ...
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane fade in active"
                ...
                <FORM id="signform" name="signform">
                    ...
                    <BUTTON CLASS="btn-block btn btn-primary" href="#" onclick="handlelogin('login'); return false;">
                        LOG IN
                    </BUTTON>
                <!--div class="clearfix py-2"></div>
<A CLASS="btn-block btn-sm btn btn-link btn-secondary" href="<?= webroot("help"); ?>#Why do I need an account">Why do I need an account?</A-->
                    <div class="clearfix py-2"></div>
                    <BUTTON CLASS="btn-sm pl-0 text-muted btn-link" style="font-weight: normal !important;" href="#" onclick="handlelogin('forgotpassword'); return false;">
                        Forgot Password
                    </BUTTON>
                </FORM>
            </div>
