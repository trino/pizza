<?php
    //do not edit this file, your phpstorm settings really screws the formatting
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        @if(!$noclose) <button data-dismiss="modal" class="btn btn-sm ml-auto align-middle bg-transparent"><i class="fa fa-times"></i></button> @endif
                    </div>
...
@if(!$justright)
    ...
    <div class="pb-3">
        <center>
            ...
            <h2 class="text-danger mt-3 pull-center">Pizza Delivery Made Simple</h2>
            ${{ $minimum }} Minimum<br>
