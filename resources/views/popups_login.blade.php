                                            ...
                                            @if(!$justright)
                                                <DIV CLASS="py-3 px-3">
                                                        <ul class="nav nav-tabs mb-1" role="tablist">
                                                            <li class="nav-item">
                                                                <a class="nav-link active bold" href="#profile"
                                                                   role="tab" data-toggle="tab" id="logintab"
                                                                   onclick="skiploadingscreen = false; ajaxerror();">Log
                                                                    in</a>
                                                            </li>
                                                            <A class="nav-link">
                                                                &nbsp;or&nbsp;
                                                            ...
                                                            <li class="nav-item">
                                                                <a class="nav-link bold" href="#buzz" role="tab"
                                                                   ...
                                                                   onclick="skiploadingscreen = true; ajaxerror();">Sign
                                                                    up</a>
                                                            </li>
                                                        </ul>
                                                            ...
                                                            <FORM id="signform" name="signform">
                                                                <div class="input_left_icon">
                                                                    <span class="fa-stack fa-2x"><i
                                                                                ...
                                                                                class="fa fa-envelope text-white fa-stack-1x"></i></span>
                                                                </div>
                                                                ...
                                                                <div class="input_left_icon">
                                                                    <span class="fa-stack fa-2x"><i
                                                                                class="fa fa-circle fa-stack-2x"></i><i
                                                                                class="fa fa-lock text-white fa-stack-1x"></i></span>
                                                                </div>
                                                                <div class="input_right">
                                                ...
                                                <div class="pb-3">
                                                    <center>
                                                        <img src="<?= webroot("images/delivery.jpg"); ?>"
                                                             class="width-50"/>
                                                        <h2 class="text-danger mt-3 pull-center">Feed Yourself + Someone
                                                            Else</h2>
                                                        ${{ $minimum }} Minimum<br>
...
<div class="py-3 px-3">
                    ...
                    <p class="pull-center">
                        <img style="max-width:100%;border:7px solid #eceeef!important"
                             src="<?= webroot("images/ultimatecombo.png"); ?>"/>
                    </p>
                    <p>We’ve partnered up with some of your favourite local pizza restaurants to bring you a one-stop
                    ...
                    <p>
                        ...
                        feeding not just yourself, but someone else! Still not convinced? – Check out our <A
                                HREF="<?= webroot("help"); ?>">FAQ</A> for more info.
                    </p>
</div>
            ...
            @if(!$justright)
                <SCRIPT>
                    ...
                    function CheckLoggedIn() {
                        if (!userisloggedin() && !$('#loginmodal').is(':visible')) {
