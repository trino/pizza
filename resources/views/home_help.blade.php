...
@section('content')
    ...
    <DIV class="row bg-white">
        <div class="col-sm-12 list-padding list-card">
            ...
            newitem("Registering", "Click the 'Signup' tab, enter a valid Hamilton address into the 'Delivery Address' field (use 'Apt/Buzzer' for things like apartment/unit/back door/etc), enter your name/email/password and click <Button class='btn btn-sm btn-primary'>Register</button>");
