...
<br><br>
    ...
    <?php
        ...
        newitem("Editing an item in your cart", 'Click <button class="fa fa-pencil-alt btn-sm"></button> to the right of the item in the receipt, the same popup you used to add the item will appear');
